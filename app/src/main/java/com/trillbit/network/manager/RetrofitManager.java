package com.trillbit.network.manager;
...
public class RetrofitManager {
    ...
    @Provides
    @Singleton
    public TrillbitDataRepository providesAPIRequestInterface(Retrofit retrofit) {
        return retrofit.create(TrillbitDataRepository.class);
    }

    @Provides
    @Singleton
    @SuppressWarnings("unused")
    public APIRequestClient providesAPIRequestClient(TrillbitDataRepository trillbitDataRepository) {
        return new APIRequestClient(trillbitDataRepository);
    }
}
